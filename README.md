...
Ghiblioteca está diseñada para los amantes del Studio Ghibli así como también para quienes están empezando a introducirse en sus animaciones, este proyecto estará encargado de mostrar cada una de las películas del estudio de una manera sencilla y accesible para el usuario.

## 2. Historias de usuario

Esta aplicación está destinada a los usuarios fanáticos y principiantes dentro del entorno del Studio Ghibli, por ese motivo se desarrollaron las siguientes "Historias de usuario" para corresponder a las necesidades de nuestros usuarios.

- Historia de usuario 01 - Yo como usuario quiero ver todas las películas para conocer todo el catálogo del estudio.
